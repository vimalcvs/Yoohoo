                ...
                if (mContext != null) {
                    ...
                    if (user != null) {
                        if (CallScreenActivity.this.user == null) {
                            CallScreenActivity.this.user = new User(CallScreenActivity.this.user.getId(), getNameById(CallScreenActivity.this.user.getId()), user.getStatus(), user.getImage());
                        } else {
                            CallScreenActivity.this.user.setName(getNameById(CallScreenActivity.this.user.getId()));
